...
class RuntimeEnv(TypedDict, total=False):
    ...
    uv: list[str] | str | UvConf
    """
    Alpha version feature. This plugin is the ``uv pip`` version of the ``pip`` plugin above. If you
...
class UvConf(TypedDict):
    packages: Required[list[str]]
    uv_version: NotRequired[str]
    uv_check: NotRequired[bool]
    uv_pip_install_options: NotRequired[list[str]]
